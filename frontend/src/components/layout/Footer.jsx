...
export default function Footer() {
  ...
  const accountLinks = [
    { to: "/register",          key: "footer.joinFree" },
    { to: "/login",             key: "footer.signIn" },
    { to: "/post-ad",           key: "footer.postAd" },
    { to: "/register-business", key: "footer.registerBusiness" },
    { to: "/my-listings",       key: "footer.myListings" },
    { to: "/profile",           key: "footer.profileSettings" },
    { to: "/points",            key: "footer.points" },
  ];
