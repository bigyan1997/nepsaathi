...
function ColHeader({ icon, label }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "7px", marginBottom: "16px" }}>
      ...
      <h3 style={{ fontSize: "12px", fontWeight: 700, color: "#fff", letterSpacing: "0.07em", textTransform: "uppercase", margin: 0 }}>
        {label}
      </h3>
    </div>
  );
    ...
    <footer>
      ...
      <div style={{ background: "#f8f7ff", borderTop: "1px solid #ece9fc" }}>
        <div
          ...
          style={{ maxWidth: "1000px", margin: "0 auto", padding: "28px 28px", display: "flex", alignItems: "center", gap: "24px", flexWrap: "wrap" }}
        >
          {/* Icon */}
          <div style={{ width: "52px", height: "52px", borderRadius: "14px", background: "#EEEDFE", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          ...
          <div style={{ flex: 1, minWidth: "200px" }}>
            <div style={{ fontWeight: 700, fontSize: "15px", color: "#26215C", marginBottom: "3px" }}>
              Stay Updated with <span style={{ color: "#534AB7" }}>NepSaathi</span>
            </div>
            <div style={{ fontSize: "13px", color: "#666", lineHeight: 1.5 }}>
              Get the latest jobs, events and community resources delivered to your inbox.
            </div>
          </div>
          {/* Form */}
          {subscribed ? (
            ...
            <form onSubmit={handleSubscribe} style={{ display: "flex", gap: "8px", flexShrink: 0, flexWrap: "wrap" }}>
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  required
                  style={{ paddingLeft: "36px", paddingRight: "14px", paddingTop: "11px", paddingBottom: "11px", border: "1.5px solid #ddd", borderRadius: "9px", fontSize: "13px", width: "230px", fontFamily: "inherit", outline: "none", background: "#fff" }}
                />
              </div>
              <button type="submit" disabled={subLoading} style={{ background: "#534AB7", color: "#fff", border: "none", borderRadius: "9px", padding: "11px 22px", fontSize: "13px", fontWeight: 600, cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap", opacity: subLoading ? 0.7 : 1 }}>
      ...
      <div style={{ background: "#26215C", color: "#fff" }}>
        <div
          ...
          style={{ maxWidth: "1000px", margin: "0 auto", padding: "44px 28px 36px", display: "grid", gridTemplateColumns: "2.2fr 1fr 1fr 1fr 1fr", gap: "36px" }}
        >
          {/* Brand */}
          <div>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              {[
                ...
                { to: "/register-business", label: t("footer.registerBusiness") },
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              ].map(({ to, label }) => <FooterLink key={label} to={to}>{label}</FooterLink>)}
            </div>
          </div>
        </div>
        ...
        <div
          ...
          style={{ maxWidth: "1000px", margin: "0 auto", padding: "16px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", flexWrap: "wrap" }}
        >
          <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "12px", color: "rgba(201,196,245,0.6)" }}>
            <span style={{ color: "rgba(201,196,245,0.5)" }}>{ICON_SHIELD}</span>
          ...
          <div style={{ display: "flex", gap: "0" }}>
            {[
              ...
              <span key={to} style={{ display: "flex", alignItems: "center" }}>
                {i > 0 && <span style={{ color: "rgba(255,255,255,0.15)", padding: "0 10px" }}>|</span>}
                <Link to={to} style={{ fontSize: "12px", color: "rgba(201,196,245,0.6)", textDecoration: "none", transition: "color 0.15s" }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = "#fff")}
                  onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(201,196,245,0.6)")}
                >
                  {label}
                </Link>
              </span>
        ...
        <div style={{ background: "rgba(0,0,0,0.15)", borderTop: "0.5px solid rgba(255,255,255,0.05)" }}>
          <div
            className="footer-copy"
            style={{ maxWidth: "1000px", margin: "0 auto", padding: "13px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", flexWrap: "wrap" }}
          >
