...
export default function HomePage() {
  ...
  return (
    <div style={{ background: "#F5F4F0", minHeight: "100vh" }}>
      ...
      {/* ── CATEGORIES ── */}
      <div
        style={{ padding: "36px 28px 0", maxWidth: "1000px", margin: "0 auto" }}
      >
        <div
          style={{
            display: "grid",
        ...
        >
          {CATEGORIES.map(({ to, emoji, label, desc, color, border }) => (
            ...
            >
              ...
              <div
                style={{ fontSize: "14px", fontWeight: 600, color: "#26215C" }}
              >
                {label}
              </div>
      ...
      {jobsData?.results?.length > 0 && (
        ...
        >
          ...
          >
            <h2 style={{ fontSize: "20px", fontWeight: 600, color: "#26215C" }}>
              Latest jobs
            </h2>
            <Link
              to="/jobs"
      ...
      {/* ── CTA BANNER ── */}
      <div
        style={{ padding: "0 28px 48px", maxWidth: "1000px", margin: "0 auto" }}
      >
        <div
          style={{
            background: "#26215C",
