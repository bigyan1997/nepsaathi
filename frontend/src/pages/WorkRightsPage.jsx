  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #e8eaf0", position: "sticky", top: "56px", zIndex: 90 }}>
        ...
        <div ref={navRef} className="work-nav" style={{ display: "flex", maxWidth: "900px", margin: "0 auto", padding: "0 8px", overflowX: "auto", WebkitOverflowScrolling: "touch", scrollbarWidth: "none" }}>
          {sections.map((s) => {
