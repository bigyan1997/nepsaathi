...
import { MapPinIcon, BriefcaseIcon, MagnifyingGlassIcon, WarningIcon, FireIcon, SquaresFourIcon, GlobeHemisphereEastIcon } from "@phosphor-icons/react";
  ...
  return (
    <>
      ...
      >
        ...
        {viewMode === "map" ? (
          <ListingsMap listings={filteredResults} type="job" />
        ) : (
          <>
